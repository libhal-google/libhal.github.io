...
| typedef boost::leaf::match&lt; T, [**value**](classhal_1_1value.md) &gt; | [**match**](#typedef-match)  <br> |
...
| Type | Name |
| ---: | :--- |
|  constexpr [**hal::bitmask**](structhal_1_1bitmask.md) | [**byte\_m**](#variable-byte_m)   = = [**byte\_mask**](structhal_1_1byte__mask.md)&lt;ByteIndex&gt;::[**value**](classhal_1_1value.md)<br>_Shorthand for using_ [_**hal::byte\_mask&lt;N&gt;::value**_](structhal_1_1byte__mask.md#variable-value) _._ |
...
|  constexpr [**hal::bitmask**](structhal_1_1bitmask.md) | [**nibble\_m**](#variable-nibble_m)   = = [**nibble\_mask**](structhal_1_1nibble__mask.md)&lt;NibbleIndex&gt;::[**value**](classhal_1_1value.md)<br>_Shorthand for using hal::nibble\_mask&lt;N&gt;::value._  |
...
|  constexpr auto | [**extract**](#function-extract) ([**bitmask**](structhal_1_1bitmask.md) p\_field, std::unsigned\_integral auto p\_value) <br> |
...
```C++
constexpr hal::bitmask hal::byte_m;
```
...
```C++
constexpr hal::bitmask hal::nibble_m;
```
