...
* **class** [**hal::accelerometer**](classhal_1_1accelerometer.md) _Acceleration sensing hardware abstraction interface._     
    * **class** [**hal::inert\_accelerometer**](classhal_1_1inert__accelerometer.md) _Inert implementation of acceleration sensing hardware._ 
* **class** [**hal::adc**](classhal_1_1adc.md) _Analog to Digital Converter (ADC) hardware abstraction interface._     
    * **class** [**hal::adc\_mux\_pin**](classhal_1_1adc__mux__pin.md) _A class that represents a multiplexer pin for ADC._ 
    * **class** [**hal::inert\_adc**](classhal_1_1inert__adc.md) _Inert implementation of Analog to Digital Converter (ADC) hardware._ 
...
* **class** [**hal::adc\_multiplexer**](classhal_1_1adc__multiplexer.md) _A driver for an ADC multiplexer that manages and reads ADC mux pins. This driver is intended to be used with multiplexers that use digital signals. An ADC multiplexer can be used to expand the number of input channels of an ADC._ 
* **class** [**hal::bit::value**](classhal_1_1bit_1_1value.md)     
    * **class** [**hal::bit::modify**](classhal_1_1bit_1_1modify.md) 
* **class** [**hal::can**](classhal_1_1can.md) _Controller Area Network (CAN bus) hardware abstraction interface._     
    * **class** [**hal::inert\_can**](classhal_1_1inert__can.md) _Inert implementation of Controller Area Network (CAN bus) hardware._ 
...
* **class** [**hal::steady\_clock**](classhal_1_1steady__clock.md) _Hardware abstraction interface for a steady clock mechanism._     
    ...
    * **class** [**hal::inert\_steady\_clock**](classhal_1_1inert__steady__clock.md) _Inert implementation of steady clock mechanism._ 
...
* **class** [**hal::timer**](classhal_1_1timer.md) _Timer hardware abstraction interface._     
    ...
    * **class** [**hal::inert\_timer**](classhal_1_1inert__timer.md) _Inert implementation of timer hardware._ 
...
* **class** [**hal::dac**](classhal_1_1dac.md) _Digital to Analog Converter (DAC) hardware abstraction interface._     
    * **class** [**hal::inert\_dac**](classhal_1_1inert__dac.md) _Inert implementation of Digital to Analog Converter (DAC) hardware._ 
...
* **class** [**hal::distance\_sensor**](classhal_1_1distance__sensor.md) _Linear distance hardware abstraction interface._     
    * **class** [**hal::inert\_distance\_sensor**](classhal_1_1inert__distance__sensor.md) _Inert implementation of linear distance hardware._ 
* **class** [**hal::esp8266::at**](classhal_1_1esp8266_1_1at.md) _esp8266 AT command driver for connecting to WiFi Access points and sending network traffic over wifi._ 
* **class** [**hal::gyroscope**](classhal_1_1gyroscope.md) _Angular velocity sensing hardware abstraction interface._     
    * **class** [**hal::inert\_gyroscope**](classhal_1_1inert__gyroscope.md) _Inert implementation of angular velocity sensing hardware._ 
* **class** [**hal::i2c**](classhal_1_1i2c.md) _Inter-integrated Circuit (I2C) hardware abstract interface._     
    * **class** [**hal::inert\_i2c**](classhal_1_1inert__i2c.md) _Inert implementation of Inter-integrated Circuit (I2C) hardware._ 
    * **class** [**hal::lpc40::i2c**](classhal_1_1lpc40_1_1i2c.md) 
    * **class** [**hal::minimum\_speed\_i2c**](classhal_1_1minimum__speed__i2c.md) _A_ [_**i2c**_](classhal_1_1i2c.md) _wrapper to ensure that the lowest_[_**i2c**_](classhal_1_1i2c.md) _device frequency is used._
* **class** [**hal::input\_pin**](classhal_1_1input__pin.md) _Digital input pin hardware abstraction interface._     
    * **class** [**hal::inert\_input\_pin**](classhal_1_1inert__input__pin.md) _Inert implementation of digital input pin hardware._ 
...
* **class** [**hal::interrupt\_pin**](classhal_1_1interrupt__pin.md) _Digital interrupt pin hardware abstraction._     
    * **class** [**hal::inert\_interrupt\_pin**](classhal_1_1inert__interrupt__pin.md) _Inert implementation of digital interrupt pin hardware._ 
...
* **class** [**hal::magnetometer**](classhal_1_1magnetometer.md) _Magnetic field strength sensing hardware abstraction interface._     
    * **class** [**hal::inert\_magnetometer**](classhal_1_1inert__magnetometer.md) _Inert implementation of magnetic field strength sensing hardware._ 
* **class** [**hal::motor**](classhal_1_1motor.md) _Hardware abstraction for an open loop rotational actuator._     
    * **class** [**hal::inert\_motor**](classhal_1_1inert__motor.md) _Inert implementation of open loop motorized actuator hardware._ 
...
* **class** [**hal::output\_pin**](classhal_1_1output__pin.md) _Digital output pin hardware abstraction._     
    * **class** [**hal::inert\_output\_pin**](classhal_1_1inert__output__pin.md) _Inert implementation of digital output pin hardware._ 
...
* **class** [**hal::pwm**](classhal_1_1pwm.md) _Pulse Width Modulation (PWM) channel hardware abstraction._     
    * **class** [**hal::inert\_pwm**](classhal_1_1inert__pwm.md) _Inert implementation of Pulse Width Modulation (PWM) channel hardware._ 
...
* **class** [**hal::rotation\_sensor**](classhal_1_1rotation__sensor.md) _Rotation measuring hardware abstraction interface._     
    * **class** [**hal::inert\_rotation\_sensor**](classhal_1_1inert__rotation__sensor.md) _Inert implementation of rotation measuring hardware._ 
...
* **class** [**hal::serial**](classhal_1_1serial.md) _Hardware abstract interface for the serial communication protocol._     
    * **class** [**hal::inert\_serial**](classhal_1_1inert__serial.md) _Inert implementation of serial communication protocol hardware._ 
...
* **class** [**hal::spi**](classhal_1_1spi.md) _Serial peripheral interface (SPI) communication protocol hardware abstract interface._     
    * **class** [**hal::inert\_spi**](classhal_1_1inert__spi.md) _Inert implementation of Serial peripheral interface (SPI) communication protocol hardware._ 
...
* **class** [**hal::temperature\_sensor**](classhal_1_1temperature__sensor.md) _Temperature sensing hardware abstraction interface._     
    * **class** [**hal::inert\_temperature\_sensor**](classhal_1_1inert__temperature__sensor.md) _Inert implementation of temperature sensing hardware._ 
...
* **class** [**hal::servo**](classhal_1_1servo.md) _Hardware abstraction for a closed loop position controlled rotational actuator._     
    * **class** [**hal::rc\_servo**](classhal_1_1rc__servo.md) _Generic RC servo driver._ 
...
* **class** [**hal::stream::fill**](classhal_1_1stream_1_1fill.md) _Non-blocking callable for reading serial data into a buffer._ 
* **class** [**hal::stream::fill\_upto**](classhal_1_1stream_1_1fill__upto.md) _Discard received bytes until the sequence is found._ 
* **class** [**hal::stream::find**](classhal_1_1stream_1_1find.md) _Discard received bytes until the sequence is found._ 
* **class** [**hal::stream::parse**](classhal_1_1stream_1_1parse.md) _Read bytes from stream and convert to integer._ 
* **class** [**hal::stream::skip**](classhal_1_1stream_1_1skip.md) _Skip number of bytes in a byte stream._ 
...
* **struct** [**hal::bit::byte\_mask**](structhal_1_1bit_1_1byte__mask.md) _Helper for generating byte position masks._ 
* **struct** [**hal::bit::mask**](structhal_1_1bit_1_1mask.md) 
* **struct** [**hal::bit::nibble\_mask**](structhal_1_1bit_1_1nibble__mask.md) _Helper for generating nibble position masks._ 
...
* **struct** [**hal::rc\_servo::settings**](structhal_1_1rc__servo_1_1settings.md) _Information about the RC servo needed to control it properly._ 
...
* **class** **hal::socket**    
    * **class** [**hal::inert\_socket**](classhal_1_1inert__socket.md) _Inert implementation of generic network sockets._ 
